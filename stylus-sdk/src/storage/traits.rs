...
pub trait GlobalStorage<'a, H: Host> {
    ...
    /// [`generic_const_exprs`]: https://github.com/rust-lang/rust/issues/76560
    unsafe fn get<const N: usize>(host: &'a H, key: U256, offset: usize) -> FixedBytes<N> {
    ...
    /// [`SLOAD`]: https://www.evm.codes/#54
    /// [`generic_const_exprs`]: https://github.com/rust-lang/rust/issues/76560
    unsafe fn get_byte(host: &'a H, key: U256, offset: usize) -> u8 {
    ...
    unsafe fn set<const N: usize>(host: &'a H, key: U256, offset: usize, value: FixedBytes<N>) {
        debug_assert!(N + offset <= 32);
    ...
    ///
    /// [`SSTORE`]: https://www.evm.codes/#55
    unsafe fn set_byte(host: &'a H, key: U256, offset: usize, value: u8) {
    ...
    ///
    /// [`SSTORE`]: https://www.evm.codes/#55
    unsafe fn clear_word(host: &'a H, key: U256) {
