...
impl SendEther {
    ...
    // This can be used to send Ether to an EOA or a Solidity smart contract that has a receive()
    ...
    // This can be used to call a Solidity smart contract's fallback function and send Ether along
    // with calldata
    #[payable]
    ...
    // The target contract can be either a Solidity smart contract or a Stylus contract that has a
    // receiveEther function, which is a payable function
    #[payable]
