...
wrap_hostio!(
    ...
    number CACHED_NUMBER block_number B256
);
...
wrap_hostio!(
    ...
    ///
    /// [`Block Numbers and Time`]: https://developer.arbitrum.io/time
    timestamp CACHED_TIMESTAMP block_timestamp u64
);
